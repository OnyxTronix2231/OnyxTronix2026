...
public class DriverUtils {
    ...
    public static Superstructure.WantedSuperState setWantedStateAsToggle(Superstructure.WantedSuperState state) {
        if (Superstructure.getInstance().getWantedSuperState() == state)
            return Superstructure.WantedSuperState.DEFAULT;
        return state;
    }
